package Practica1Magdiel;

import java.awt.*;
import java.awt.event.*;

public class CalculadoraMag extends Frame implements ActionListener{
    int c,n;
    ...
    public static void main(String[] args) {
        CalculadoraMag micalc = new CalculadoraMag();
    }
}
